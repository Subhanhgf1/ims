...
export default function LoginForm() {
  ...
  const handleChangePassword = async (e) => {
    ...
    setCpLoading(true)
    try {
      // First verify the user exists by logging in
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 text-sm text-center">
                <button onClick={() => { setShowChangePassword(false); setCpError(""); setCpSuccess("") }} className="font-medium text-blue-600 hover:text-blue-500">Back to Sign In</button>
              </div>
            </CardContent>
          </Card>
        )}
