...
const Card = forwardRef(({ className = "", ...props }, ref) => {
  return <div ref={ref} className={`rounded-lg border border-gray-200 bg-white shadow-sm ${className}`} {...props} />
})
...
const CardTitle = forwardRef(({ className = "", ...props }, ref) => {
  return <h2 ref={ref} className={`text-2xl font-semibold leading-none tracking-tight ${className}`} {...props} />
})
