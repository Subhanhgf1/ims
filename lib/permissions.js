...
export const PERMISSIONS = {
  ...
  // Failed Delivery
  FAILED_DELIVERY_VIEW:    "failed_delivery.view",
  FAILED_DELIVERY_SCAN:    "failed_delivery.scan",
  FAILED_DELIVERY_PROCESS: "failed_delivery.process",
  FAILED_DELIVERY_DELETE:  "failed_delivery.delete",
}
...
const ROLE_DEFAULTS = {
  ADMIN: {
    ...
    "settings.view":      true,
    "users.manage":       true,
    "failed_delivery.view":    true,
    "failed_delivery.scan":    true,
    "failed_delivery.process": true,
    "failed_delivery.delete":  true,
  },
  MANAGER: {
    "inbound.view":       true,
    "inbound.create":     true,
  ...
  OPERATOR: {
    ...
    "failed_delivery.view":    true,
    "failed_delivery.scan":    true,
    "failed_delivery.process": false,
    "failed_delivery.delete":  false,
  },
}
